...
#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { sensor }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS33} [get_ports {reset}];

##RGB LEDs

set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports {read}];
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { led4_g }]; #IO_L16P_T2_35 Sch=led4_g
#set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { e }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led4_r
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports {full}];
...
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {en_led}];
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {take_ctrl_led}];
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports {err_led}];
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports {empty}];
...
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS33} [get_ports {home}];
#set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS33} [get_ports {sensor}];

##Pmod Header JA

#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { pulse }]; #IO_L17P_T2_34 Sch=ja_p[1]
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { pulse }]; #IO_L17N_T2_34 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { sensor }]; #IO_L7P_T1_34 Sch=ja_p[2]
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { sensor }]; #IO_L7N_T1_34 Sch=ja_n[2]
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { pulse }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports {pulse}]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
#set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports {pulse }]; #IO_L22P_T3_34 Sch=ja_p[4]
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports {pulse }]; #IO_L22N_T3_34 Sch=ja_n[4]

##Pmod Header JB

#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { jb[0] }]; #IO_L8P_T1_34 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { en }]; #IO_L8N_T1_34 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { direc }]; #IO_L1P_T0_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { pulse}]; #IO_L1N_T0_34 Sch=jb_n[2]
...
#set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {pulse}];
#set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports {direc}];
...
#set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports {clk_250k}];
...
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { rd_clk }]; #IO_L15P_T2_DQS_13 Sch=ck_io[32]
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { rd_en}]; #IO_L21N_T3_DQS_13 Sch=ck_io[33]
#set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { direc_back }]; #IO_L16P_T2_13 Sch=ck_io[34]
...
#set_property -dict {PACKAGE_PIN Y7 IOSTANDARD LVCMOS33} [get_ports clk1k]
#set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS33} [get_ports {wr_en}];
#set_property -dict {PACKAGE_PIN Y8 IOSTANDARD LVCMOS33} [get_ports {wr_clk}];
#set_property -dict {PACKAGE_PIN W9 IOSTANDARD LVCMOS33} [get_ports {pulse_scurve}];
#set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { sensor }]; #IO_L14P_T2_SRCC_13 Sch=ck_io[41]
#set_property -dict {PACKAGE_PIN Y13 IOSTANDARD LVCMOS33} [get_ports {pulse_home}];
