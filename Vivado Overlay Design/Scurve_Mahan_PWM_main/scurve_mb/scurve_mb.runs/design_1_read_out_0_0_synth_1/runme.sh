...
HD_PWD='C:/Users/adomy/Documents/EGR4820/senior_project/Scurve_Mahan_PWM_main/scurve_mb/scurve_mb.runs/design_1_read_out_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_read_out_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_read_out_0_0.tcl
