...
set C_modelArgList {
	...
	{ buf_len_V int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_data_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in_data.data.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "buf_len_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "buf_len.V","cData": "int32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} ]}
...
set portList { 
	...
	{ out_data_TREADY sc_in sc_logic 1 outacc 7 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"buf_len_V","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_AXILiteS_BRESP", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "AXILiteS", "role": "BRESP" } }, 
 	...
 	{ "name": "out_data_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "out_data_data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "buf_len_V", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.hailstone_AXILiteS_s_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	hailstone {
		in_data_data_V {Type I LastRead 2 FirstWrite -1}
		in_data_keep_V {Type I LastRead 2 FirstWrite -1}
		in_data_strb_V {Type I LastRead 2 FirstWrite -1}
		in_data_user_V {Type I LastRead 2 FirstWrite -1}
		in_data_last_V {Type I LastRead 2 FirstWrite -1}
		in_data_id_V {Type I LastRead 2 FirstWrite -1}
		in_data_dest_V {Type I LastRead 2 FirstWrite -1}
		out_data_data_V {Type O LastRead -1 FirstWrite 3}
		out_data_keep_V {Type O LastRead -1 FirstWrite 3}
		out_data_strb_V {Type O LastRead -1 FirstWrite 3}
		out_data_user_V {Type O LastRead -1 FirstWrite 3}
		out_data_last_V {Type O LastRead -1 FirstWrite 3}
		out_data_id_V {Type O LastRead -1 FirstWrite 3}
		out_data_dest_V {Type O LastRead -1 FirstWrite 3}
		buf_len_V {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	out_data_data_V { axis {  { out_data_TDATA out_data 1 32 }  { out_data_TREADY out_acc 0 1 } } }
	...
	out_data_dest_V { axis {  { out_data_TVALID out_vld 1 1 }  { out_data_TDEST out_data 1 1 } } }
}
