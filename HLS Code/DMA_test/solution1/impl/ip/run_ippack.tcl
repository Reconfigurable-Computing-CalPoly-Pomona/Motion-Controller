...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 buf_len_V W 0x0 "Data signal of buf_len_V" {{0 32 buf_len_V W 0 "Bit 31 to 0 Data signal of buf_len_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
