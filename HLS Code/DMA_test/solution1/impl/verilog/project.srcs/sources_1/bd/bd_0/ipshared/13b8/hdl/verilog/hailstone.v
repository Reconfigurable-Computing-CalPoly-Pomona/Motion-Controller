...
(* CORE_GENERATION_INFO="hailstone,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.772312,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=573,HLS_SYN_LUT=1046,HLS_VERSION=2018_3}" *)
...
wire   [31:0] buf_len_V;
reg   [31:0] buf_len_V_0_data_reg;
reg    buf_len_V_0_vld_reg;
reg    buf_len_V_0_ack_out;
...
reg   [31:0] buf_len_V_read_reg_324;
wire    ap_CS_fsm_state2;
wire   [30:0] i_fu_184_p2;
reg   [30:0] i_reg_332;
reg    ap_block_state3;
reg   [3:0] in_data_keep_V_tmp_reg_342;
reg   [3:0] in_data_strb_V_tmp_reg_347;
reg   [0:0] in_data_user_V_tmp_reg_352;
reg   [0:0] in_data_last_V_tmp_reg_357;
reg   [0:0] in_data_id_V_tmp_reg_362;
reg   [0:0] in_data_dest_V_tmp_reg_367;
wire   [31:0] count_fu_222_p2;
reg    ap_predicate_op60_write_state4;
reg    ap_block_state4_io;
wire   [31:0] tmp_8_fu_256_p2;
wire   [31:0] count_2_fu_262_p2;
wire   [31:0] cur_1_fu_316_p3;
wire    ap_CS_fsm_state5;
reg   [30:0] i_op_assign_reg_119;
reg   [31:0] cur1_reg_130;
reg   [31:0] val_assign_reg_140;
reg   [31:0] cur_1_in_reg_154;
reg   [31:0] count_1_reg_164;
wire   [31:0] i_op_assign_cast_fu_175_p1;
wire   [30:0] tmp_4_fu_228_p4;
wire   [31:0] tmp_5_fu_244_p2;
wire   [31:0] tmp_7_fu_250_p2;
wire   [31:0] p_neg_fu_276_p2;
wire   [30:0] p_lshr_fu_282_p4;
wire   [31:0] tmp_2_fu_292_p1;
wire   [30:0] p_lshr_f_fu_302_p4;
wire   [0:0] tmp_6_fu_268_p3;
wire   [31:0] p_neg_t_fu_296_p2;
wire   [31:0] tmp_3_fu_312_p1;
...
#0 buf_len_V_0_data_reg = 32'd0;
#0 buf_len_V_0_vld_reg = 1'b0;
#0 ap_CS_fsm = 7'd1;
end

hailstone_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
hailstone_AXILiteS_s_axi_U(
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state4_io) & (1'b1 == ap_CS_fsm_state4))) begin
        if ((tmp_1_fu_218_p1 == 1'd0)) begin
            count_1_reg_164 <= count_fu_222_p2;
        end else if (((tmp_1_fu_218_p1 == 1'd1) & (icmp_fu_238_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((tmp_fu_179_p2 == 1'd1) & (in_data_data_V_0_vld_out == 1'b0)) & (tmp_fu_179_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((out_data_data_V_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state6))) begin
        i_op_assign_reg_119 <= i_reg_332;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        i_op_assign_reg_119 <= 31'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        val_assign_reg_140 <= 32'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((((buf_len_V_0_vld_reg == 1'b0) & (1'b1 == 1'b1)) | ((buf_len_V_0_ack_out == 1'b1) & (1'b1 == 1'b1) & (buf_len_V_0_vld_reg == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if ((~((tmp_fu_179_p2 == 1'd1) & (in_data_data_V_0_vld_out == 1'b0)) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((~((tmp_fu_179_p2 == 1'd1) & (in_data_data_V_0_vld_out == 1'b0)) & (tmp_fu_179_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if ((~((out_data_dest_V_1_ack_in == 1'b0) | (out_data_id_V_1_ack_in == 1'b0) | (out_data_last_V_1_ack_in == 1'b0) | (out_data_user_V_1_ack_in == 1'b0) | (out_data_strb_V_1_ack_in == 1'b0) | (out_data_keep_V_1_ack_in == 1'b0) | (out_data_data_V_1_ack_in == 1'b0)) & (1'b1 == ap_CS_fsm_state7))) begin
        buf_len_V_0_ack_out = 1'b1;
    end else begin
        buf_len_V_0_ack_out = 1'b0;
    end
end

always @ (*) begin
    if (((tmp_fu_179_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) | ((icmp_fu_238_p2 == 1'd1) & (tmp_1_fu_218_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state4)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state4_io) & (ap_predicate_op60_write_state4 == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            ...
            end else if ((~((tmp_fu_179_p2 == 1'd1) & (in_data_data_V_0_vld_out == 1'b0)) & (tmp_fu_179_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b0 == ap_block_state4_io) & (icmp_fu_238_p2 == 1'd1) & (tmp_1_fu_218_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else if (((1'b0 == ap_block_state4_io) & (1'b1 == ap_CS_fsm_state4) & ((icmp_fu_238_p2 == 1'd0) | (tmp_1_fu_218_p1 == 1'd0)))) begin
...
always @ (*) begin
    ap_block_state3 = ((tmp_fu_179_p2 == 1'd1) & (in_data_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_block_state4_io = ((ap_predicate_op60_write_state4 == 1'b1) & (out_data_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state7 = ((out_data_dest_V_1_ack_in == 1'b0) | (out_data_id_V_1_ack_in == 1'b0) | (out_data_last_V_1_ack_in == 1'b0) | (out_data_user_V_1_ack_in == 1'b0) | (out_data_strb_V_1_ack_in == 1'b0) | (out_data_keep_V_1_ack_in == 1'b0) | (out_data_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_predicate_op60_write_state4 = ((icmp_fu_238_p2 == 1'd1) & (tmp_1_fu_218_p1 == 1'd1));
end
...
assign count_2_fu_262_p2 = (32'd2 + val_assign_reg_140);

assign count_fu_222_p2 = (val_assign_reg_140 + 32'd1);

assign cur_1_fu_316_p3 = ((tmp_6_fu_268_p3[0:0] === 1'b1) ? p_neg_t_fu_296_p2 : tmp_3_fu_312_p1);

assign i_fu_184_p2 = (i_op_assign_reg_119 + 31'd1);

assign i_op_assign_cast_fu_175_p1 = i_op_assign_reg_119;

assign icmp_fu_238_p2 = (($signed(tmp_4_fu_228_p4) < $signed(31'd1)) ? 1'b1 : 1'b0);
...
assign p_lshr_f_fu_302_p4 = {{cur_1_in_reg_154[31:1]}};

assign p_lshr_fu_282_p4 = {{p_neg_fu_276_p2[31:1]}};

assign p_neg_fu_276_p2 = (32'd0 - cur_1_in_reg_154);

assign p_neg_t_fu_296_p2 = (32'd0 - tmp_2_fu_292_p1);

assign tmp_1_fu_218_p1 = cur1_reg_130[0:0];

assign tmp_2_fu_292_p1 = p_lshr_fu_282_p4;

assign tmp_3_fu_312_p1 = p_lshr_f_fu_302_p4;

assign tmp_4_fu_228_p4 = {{cur1_reg_130[31:1]}};

assign tmp_5_fu_244_p2 = cur1_reg_130 << 32'd2;

assign tmp_6_fu_268_p3 = cur_1_in_reg_154[32'd31];

assign tmp_7_fu_250_p2 = (tmp_5_fu_244_p2 - cur1_reg_130);

assign tmp_8_fu_256_p2 = (32'd1 + tmp_7_fu_250_p2);

assign tmp_fu_179_p2 = (($signed(i_op_assign_cast_fu_175_p1) < $signed(buf_len_V_read_reg_324)) ? 1'b1 : 1'b0);
