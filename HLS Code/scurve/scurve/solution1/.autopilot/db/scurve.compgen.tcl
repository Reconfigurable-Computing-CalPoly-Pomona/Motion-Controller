...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 29 \
			corename scurve_scrv_axilite \
			name scurve_scrv_s_axi \
			ports {$port_scrv} \
			op interface \
			is_flushable 0 \ 
		} "
	} else {
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'scrv'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler scurve_scrv_s_axi
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_vout \
    op interface \
    ports { vout_din { O 32 vector } vout_full_n { I 1 bit } vout_write { O 1 bit } } \
} "
}
