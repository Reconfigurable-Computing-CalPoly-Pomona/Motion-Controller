...
#ifndef __manage_sdiv_25ns_cud__HH__
#define __manage_sdiv_25ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(manage_sdiv_25ns_cud) {
    ...
    SC_CTOR(manage_sdiv_25ns_cud):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
