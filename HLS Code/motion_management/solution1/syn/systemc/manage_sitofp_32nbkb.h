...
#ifndef __manage_sitofp_32nbkb__HH__
#define __manage_sitofp_32nbkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(manage_sitofp_32nbkb) {
    ...
    SC_CTOR(manage_sitofp_32nbkb):  ACMP_sitofp_U ("ACMP_sitofp_U") {
